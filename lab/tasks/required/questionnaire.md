...
2. Status code (item not found): **(не указано явно, предположительно 404)**
...
2. Where do you set the API key value for Docker Compose? (file name): **(не указано в документации, обычно `.env` или `docker-compose.yml`)**
